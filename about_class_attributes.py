...
class AboutClassAttributes(Koan):
    ...
    def test_objects_are_objects(self):
        fido = self.Dog()
        # all the class of python is inherited(derieved) from object class
        # so, fido is an instance of object
    ...
    class Dog2:
        ...
        # staticmethod don't have access to the reference of class
        # so can't interact with other method and attribute of class
        @staticmethod
        def bark():
            return "staticmethod bark, arg: None"

        # classmethod has access to the reference of class
        # so can interact with other method and attribute of class 
        @classmethod
        def growl(cls):
    ...
    # Python has a special rule that when you look up an attribute in an object and it isn't found there, 
    # the object's class also gets checked
